            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full">
                <input 
                  ...
                  className="px-4 py-3 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-full text-gray-900 placeholder-gray-500"
                />
